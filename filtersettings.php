...
$settings->add(new admin_setting_configtext('filter_babelium_serverdomain',
					    get_string('serverdomain','filter_babelium'),
					    get_string('serverdomain_help','filter_babelium'),
					    'babeliumproject.com',
					    PARAM_TEXT));

$settings->add(new admin_setting_configtext('filter_babelium_serverport',
					    get_string('serverport','filter_babelium'),
					    get_string('serverport_help','filter_babelium'),
					    '80',
					    PARAM_INT));

$settings->add(new admin_setting_configtext('filter_babelium_apidomain',
					    get_string('apidomain','filter_babelium'),
					    get_string('apidomain_help','filter_babelium'),
					    'babeliumproject.com/api',
					    PARAM_TEXT));
					    
$settings->add(new admin_setting_configtext('filter_babelium_apiendpoint',
					    get_string('apiendpoint','filter_babelium'),
					    get_string('apiendpoint_help','filter_babelium'),
					    'rest.php',
					    PARAM_TEXT));

$settings->add(new admin_setting_configpasswordunmask('filter_babelium_accesskey',
					    	      get_string('accesskey','filter_babelium'),
					    	      get_string('accesskey_help','filter_babelium'),
						      ''));

$settings->add(new admin_setting_configpasswordunmask('filter_babelium_secretaccesskey',
